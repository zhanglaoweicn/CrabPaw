...
describe('findViolations', () => {
  ...
  const GOOD = [
    ...
    // 文档白名单: 产品树 md + 许可证类 md(2026-09-09 包内文档规则)
    'resources/src/core/prompts/stable-ship.md',
    'resources/src/core/agent/souls/domains/finance.md',
    'resources/skills/pdf-generator/SKILL.md',
    'resources/npm/node_modules/ms/license.md',
    'resources/portable/python/Lib/site-packages/pip/LICENSE.md'
  ]
  const BAD = [
    ...
    // 文档残留(2026-09-09 包内文档规则): 第三方说明文档一律拦截
    'resources/npm/docs/content/commands/npm-install.md',
    'resources/npm/README.md',
    'resources/node_modules/some-pkg/readme.md',
    'resources/node_modules/node-gyp/CHANGELOG.md',
    'resources/node_modules/diff/CONTRIBUTING.md',
    'resources/node_modules/socks/docs/index.md',
    'resources/resources/kws-model/README.md'
  ]
