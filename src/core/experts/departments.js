...
const ROLE_ALIASES = Object.freeze({
  ...
  'marketing-douyin-strategist': ['抖音', '短视频'],
  ...
  'marketing-livestream-commerce-coach': ['直播', '直播带货', '直播电商'],
  'finance-bookkeeper-controller': ['记账', '会计', '账务', '做账', '报表', '财务总监', '财务分析'],
  'finance-invoice-manager': ['发票', '发票管理', '报销发票'],
  'finance-tax-strategist': ['税务', '报税', '税收筹划'],
  'finance-financial-forecaster': ['财务预测', '预算编制'],
  'sales-deal-closing-coach': ['逼单', '成交话术', '签单'],
  'sales-pipeline-architect': ['销售漏斗', '商机'],
  'sales-coach': ['销售教练', '谈单'],
  'legal-contract-reviewer': ['审合同', '合同风险', '法务审查'],
  'legal-policy-writer': ['制度文件', '写制度'],
  'hr-recruiter': ['招聘', '简历筛选', '招人'],
  'hr-performance-reviewer': ['绩效', '绩效考核'],
  'product-manager': ['产品经理', '产品'],
  'engineering-ai-engineer': ['ai工程师', '人工智能'],
  'engineering-devops-automator': ['运维', 'devops'],
  'strategy-business-strategist': ['战略顾问', '商业模式'],
  'strategy-industry-analyst': ['行业分析', '行业研究', '赛道'],
  'strategy-biz-plan-writer': ['商业计划书', '融资计划'],
  'strategy-annual-planning': ['年度规划', '经营规划'],
});
